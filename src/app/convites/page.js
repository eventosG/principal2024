  ...
  return (
    <div className='container lg:mx-auto lg:min-h-50vh'>
      ...
      <div className='flex flex-col'>       
        ...
        {isConviteClicked ? (<>{listServicos.map((item) => (
          <>
            <p className="mb-1 hover:text-sky-600 cursor-pointer" onClick={() => setIsSelected(item.servico)}>{item.servico}</p>
          </>
        ))}</>):(
        <>
        <p className="mb-1 hover:text-sky-600 cursor-pointer" onClick={() => setIsConviteCliced((env) => !env)}>Convites</p>
        <p className="mb-1 hover:text-sky-600 cursor-pointer">Cartão de Instruções</p>
        <p className="mb-1 hover:text-sky-600 cursor-pointer">Identificador de Mesas</p>
        <p className="mb-1 hover:text-sky-600 cursor-pointer">Caderno de Dedicatória</p>
        </>
        )}
                    ...
                    {isSelected === "Todos Convites" ? (<></>):(
                        <>
                            <TEDropdown>
                                ...
                                <TEDropdownMenu>
                                <TEDropdownItem>
                                    <a onClick={() => Preco()} href="#" className="block w-full min-w-[160px] cursor-pointer whitespace-nowrap bg-transparent px-4 py-2 text-sm text-left font-normal pointer-events-auto text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:bg-neutral-100 focus:bg-neutral-100 focus:text-neutral-800 focus:outline-none active:no-underline dark:text-neutral-200 dark:hover:bg-neutral-600 dark:focus:bg-neutral-600 dark:active:bg-neutral-600">
                                    Preço
                                    </a>
                                </TEDropdownItem>
                                <TEDropdownItem>
                                    <a onClick={() => Material()} href="#" className="block w-full min-w-[160px] cursor-pointer whitespace-nowrap bg-transparent px-4 py-2 text-sm text-left font-normal pointer-events-auto text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:bg-neutral-100 focus:bg-neutral-100 focus:text-neutral-800 focus:outline-none active:no-underline dark:text-neutral-200 dark:hover:bg-neutral-600 dark:focus:bg-neutral-600 dark:active:bg-neutral-600">
                                    Material
                                    </a>
                                </TEDropdownItem>
                                </TEDropdownMenu>
            ...
            <div className="mt-4">
              {isSelected === "Todos Convites" ? (
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className='block rounded-lg bg-white my-4 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700'>
                        <p className="font-bold text-center">Convidados Confirmados</p>
                ...
                <div className="grid grid-cols-5 gap-4">
                  <div
                    ...
                    <div className="py-2">
                      ...
                      <h5
                        className="mt-4 text-center text-sm font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                        Preço: 0.00
                      </h5>
                    </div>
                  </div>
