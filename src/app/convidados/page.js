...
import { TEChart, TETextarea, TESelect  } from "tw-elements-react";
import {
    TEDropdown,
    TEDropdownToggle,
    TEDropdownMenu,
        ...
        {IsRSVP ? (
            ...
            <>
                ...
                <div className="gap-4 flex justify-center">
                    <div onClick={() => setShowVisao(false)} className='block rounded-lg bg-white my-4 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700'>
                        <p>Visão Geral</p>
                    </div>
                    <div onClick={() => momento("Almoço")} className='block rounded-lg bg-white my-4 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700'>
                        <p>Almoço</p>
                    </div>
                    <div onClick={() => momento("Enlace Matrimonial")} className='block rounded-lg bg-white my-4 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700'>
                        <p>Enlace Matrimonial</p>
                    </div>
                    <div onClick={() => momento("After Party")} className='block rounded-lg bg-white my-4 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700'>
                        <p>After Party</p>
                    </div>
                </div>
                <hr />
                                        ...
                                        <div className="overflow-hidden">
                                            <table className="min-w-full text-center text-sm font-light">
                                                <thead
                                                    ...
                                                    <th scope="col" className=" px-6 py-4">Mesa</th>
                                                    <th scope="col" className=" px-6 py-4">Participação</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td className="whitespace-nowrap  px-6 py-4">Maria Miguel</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Noivos</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Presencial</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-red-500">Cancelado</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-red-500 cursor-pointer">...</td>
                                                    </tr>
                                                    <tr className="border-b dark:border-neutral-500">
                                                    <td className="whitespace-nowrap  px-6 py-4 font-medium">2</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Miguel Cossa</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Noivos</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Presencial</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-green-500">Confirmado</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-red-500 cursor-pointer">...</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div className="overflow-hidden">
                                            <table className="min-w-full text-center text-sm font-light">
                                                <thead
                                                    ...
                                                    <th scope="col" className=" px-6 py-4">Nome</th>
                                                    <th scope="col" className=" px-6 py-4">Mesa</th>
                                                    <th scope="col" className=" px-6 py-4">Momento</th>
                                                    <th scope="col" className=" px-6 py-4">Participação</th>
                                                    <th scope="col" className=" px-6 py-4">Status</th>
                                                    <th scope="col" className=" px-6 py-4"></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr className="border-b dark:border-neutral-500">
                                                    <td className="whitespace-nowrap  px-6 py-4 font-medium">1</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Ana Jacinto</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Anjos</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">{momentoText}</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Presencial</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-yellow-500">Pendente</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-yellow-500 cursor-pointer">...</td>
                                                    </tr>
                                                    <tr className="border-b dark:border-neutral-500">
                                                    <td className="whitespace-nowrap  px-6 py-4 font-medium">2</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Luis Cossa</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Querubim</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">{momentoText}</td>
                                                    <td className="whitespace-nowrap  px-6 py-4">Presencial</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-red-500">Recusado</td>
                                                    <td className="whitespace-nowrap  px-6 py-4 text-red-500 cursor-pointer">...</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <div className="overflow-hidden">
                                                <table className="min-w-full text-center text-sm font-light">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td className="whitespace-nowrap  px-6 py-4">Ana Jacinto</td>
                                                        <td className="whitespace-nowrap  px-6 py-4">Anjos</td>
                                                        <td className="whitespace-nowrap  px-6 py-4">Momento</td>
                                                        <td className="whitespace-nowrap  px-6 py-4">Presencial</td>
                                                        <td className="whitespace-nowrap  px-6 py-4 text-yellow-500">Pendente</td>
                                                        <td className="whitespace-nowrap  px-6 py-4 text-yellow-500 cursor-pointer">...</td>
                                                        </tr>
