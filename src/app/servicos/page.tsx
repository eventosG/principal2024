                  ...
                  {selectedProduct === "Categoria" && (
                    <>
                      <TEDropdown>
                        ...
                        <TEDropdownMenu>
                          <TEDropdownItem>
                            <a onClick={() => setIsFiltroSelected((prev) => !prev)} href="#" className="block w-full min-w-[160px] cursor-pointer whitespace-nowrap bg-transparent px-4 py-2 text-sm text-left font-normal pointer-events-auto text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:bg-neutral-100 focus:bg-neutral-100 focus:text-neutral-800 focus:outline-none active:no-underline dark:text-neutral-200 dark:hover:bg-neutral-600 dark:focus:bg-neutral-600 dark:active:bg-neutral-600">
                            Categoria 1
                            </a>
                          </TEDropdownItem>
                          <TEDropdownItem>
                ...
                <>
                  <TEDropdown>
                    ...
                    <TEDropdownMenu>
                      ...
                      <TEDropdownItem>
                        <a onClick={() => Categoria()} href="#" className="block w-full min-w-[160px] cursor-pointer whitespace-nowrap bg-transparent px-4 py-2 text-sm text-left font-normal pointer-events-auto text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:bg-neutral-100 focus:bg-neutral-100 focus:text-neutral-800 focus:outline-none active:no-underline dark:text-neutral-200 dark:hover:bg-neutral-600 dark:focus:bg-neutral-600 dark:active:bg-neutral-600">
                          Categoria
                        </a>
                      </TEDropdownItem>
                      <TEDropdownItem>
            ...
            {isSelected === "Transporte" && (
              <>
                <div className="flex flex-row gap-4 mt-14">
                  <div>
                    <h3 className="font-bold cursor-pointer mx-4">Acompanhantes e convidados</h3>
                  </div>
                </div>
                <hr className="mx-4" />
