  ...
  return (
    <div className='container lg:mx-auto lg:min-h-50vh'>
      ...
      <div className='flex flex-col col-span-2'>       
        ...
        {isClicked ? (
          <>
          <p className="font-bold text-center mb-4">Serviços Seleccionados</p>
          {listServicos3.map((item) => (
            <>
              <div key={item.servico} className="flex flex-row justify-between mb-2 block rounded-lg bg-white p-2 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <p className=" text-sm" onClick={() => setIsSelected((prev) => !prev)}>{item.servico}</p>
                <div className="flex flex-row gap-2">                  
                  <p className="text-sm">{item.preco}</p>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-3 mt-1">
      ...
      <div className='block col-span-4 w-full'>
        {isClicked ? (
          <>
            <button
              type="button"
            ...
            {isSelected ? (
              <>
                <div className='text-center mt-4 underline mb-4'>SERVIÇO SELECCIONADO</div>
              ...
              <>
              <div className='text-center mt-4 underline mb-4'>ORÇAMENTO</div>
            <div className="flex flex-row justify-between mx-8">
              <div className="flex flex-col text-center">
            ...
            <hr className="mx-4"/>
            <div className='text-center mt-4 underline mb-4'>Destribuição de Custos</div>
          ...
          <>
          <div className='text-center mt-4 underline mb-4'>ORÇAMENTAÇÃO</div>
          <div className='flex flex-row justify-center gap-12'>
            ...
            <div className='text-center'>
              ...
              <div className='rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 w-60' onClick={() => setIsClicked((prev) => !prev)}></div>
            </div>          
            <div>
          ...
          <div className='text-center mt-4 underline mb-4'>SELECÇÃO DE SERVIÇOS</div>
          <button
            type="button"
