      ...
      <div className='grid grid-cols-1 lg:grid-cols-6 gap-4'>
        ...
        <div className='block w-full col-span-3 my-10'>
            <div className='block rounded-lg bg-white my-4 p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700'>
                <p className="font-bold text-center mb-1">Nome do Produto/Serviço</p>
                <hr />
                <div className="w-1/2">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div>
                            <div className="cursor-pointer" onClick={() => setShowModal(true)}>Incluso</div>
                        </div>
                    </div>
                    <div className="flex justify-between">
                        <div>
                        ...
                        <div>
                            <div className="cursor-pointer" onClick={() => setShowModal2(true)}>Incluso</div>
                        </div>
                    </div>
                    <div className="flex justify-between">
                        <div>
